...
const PngToGif = () => {
    ...
    const handleDrop = (e) => {
        ...
        if (file && file.type === 'image/png') {
            ...
            setMessage("Please drop a valid PNG file.");
        }
    };
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            link.href = url;
            link.setAttribute('download', selectedFile.name.replace(/\.[^/.]+$/, '') + '.gif');
                ...
                <div className="items-center justify-center mx-auto">
                    <div className="text-center pt-20 mb-10">
                        ...
                        <p className="text-2xl text-gray-500">
                            Easily convert PNG files to GIF format online, without having
                        ...
                        <div className={`flex-1 ${selectedFile ? 'md:mr-4' : ''} mb-8 md:mb-0`}>
                            {!selectedFile ? (
                                <div className="text-center">
                                    ...
                                    <div className="text-3xl">Drag and Drop PNG Files</div>
