...
const ImageToPdf = () => {
    ...
    const handleDrop = (e) => {
        ...
        if (file && (file.type === 'image/jpeg' || file.type === 'image/png')) {
            ...
            setMessage("Please drop a valid JPG or PNG file.");
        }
    };
                ...
                <div className="items-center justify-center mx-auto">
                    <div className="text-center pt-20 mb-10">
                        ...
                        <p className="text-2xl text-gray-500">
                            Easily convert image files to PDF format online, without having
                        ...
                        <div className={`flex-1 ${selectedFile ? 'md:mr-4' : ''} mb-8 md:mb-0`}>
                            {!selectedFile ? (
                                <div className="text-center">
                                    ...
                                    <div className="text-3xl">Drag and Drop Image Files</div>
